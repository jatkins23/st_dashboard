...
def _menu_item(control, label: str, min_width: str = "80px"):
    """One menu tile: control on top, label below."""
    return html.Div(
        [
            html.Div(control, style={"width": "100%"}),
            html.Div(
                label,
                style={
                    "fontSize": "11px",
